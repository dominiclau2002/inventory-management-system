        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <?php if($is_logged_in): ?>
                    <li class="nav-item">
                        <a class="nav-link <?php echo $current_page === 'products' ? 'active' : ''; ?>" href="/products/products.php">
                            <i class="fas fa-warehouse me-1"></i>Products
                        </a>
                    </li>
                    <?php if(isset($_SESSION["role"]) && $_SESSION["role"] == "admin"): ?>
                    <li class="nav-item">
                        <a class="nav-link <?php echo $current_page === 'borrows' ? 'active' : ''; ?>" href="/products/borrows/borrow.php">
                    ...
                    <?php else: ?>
                    <li class="nav-item">
                        <a class="nav-link <?php echo $current_page === 'my_borrows' ? 'active' : ''; ?>" href="/products/borrows/my_borrows.php">
